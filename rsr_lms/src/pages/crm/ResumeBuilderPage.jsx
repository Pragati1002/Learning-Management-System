...
export const ResumeBuilderPage = () => {
  ...
  const [form, setForm] = useState(resumeData ? { ...resumeData } : defaultResume());
      ...
      {editing ? (
        <div className="bg-white p-6 rounded-3xl border border-purple-100 shadow-sm space-y-5 print:hidden">
          ...
          <div>
            ...
            <input autoComplete="off" value={form.education} onChange={e => setForm({ ...form, education: e.target.value })} placeholder="e.g. B.Tech Computer Science — Your College Name" className="w-full p-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-purple-500 focus:outline-none" />
          </div>
