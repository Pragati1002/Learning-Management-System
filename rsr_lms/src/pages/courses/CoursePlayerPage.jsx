        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-black rounded-3xl overflow-hidden shadow-2xl aspect-video border border-slate-800">
            {activeLesson.videoUrl ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center px-8 text-white">
                <div className="text-4xl mb-3">📚</div>
                <h3 className="text-lg font-extrabold">{activeLesson.title}</h3>
                <p className="text-sm text-slate-300 mt-2 max-w-xl">
                  This lesson uses course-specific notes and practice material. No unrelated demo video is attached to this lesson.
                </p>
              </div>
            )}
          </div>
