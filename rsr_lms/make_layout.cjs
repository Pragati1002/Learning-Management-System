...
write('src/components/layout/Navbar.jsx', [
  ...
  "import { GraduationCap, Sparkles, UserCheck, ChevronDown, BookOpen, Shield, Laptop, DollarSign, Briefcase } from 'lucide-react';",
  "",
  "export const Navbar = ({ onOpenAITutor, onOpenAIQuiz }) => {",
  "  const { currentUser, switchRole, setActiveTab } = useLMS();",
  "  const [roleDropdownOpen, setRoleDropdownOpen] = useState(false);",
  "",
  "  const roles = [",
  "    { id: 'admin', label: 'Admin', desc: 'Manage system, users & settings', icon: Shield, color: 'text-purple-600' },",
  "    { id: 'trainer', label: 'Trainer', desc: 'Courses, batches, assignments & exams', icon: Laptop, color: 'text-emerald-600' },",
  ...
  "              </div>",
  "              <p className=\"text-[11px] text-slate-500 font-medium hidden sm:block\">Complete Training & Learning Solution</p>",
  "            </div>",
  "          </div>",
  "",
  ...
  "              className=\"flex items-center space-x-1.5 px-3 py-1.5 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white text-xs sm:text-sm font-semibold rounded-lg shadow-sm hover:shadow-md hover:opacity-95 transition-all ai-glow\"",
  "            >",
  "              <Sparkles className=\"w-4 h-4\" />",
  "              <span className=\"hidden md:inline\">AI Learning Tutor</span>",
  "              <span className=\"md:hidden\">AI Tutor</span>",
  "            </button>",
  "",
  "            <button ",
  ...
  "                className=\"flex items-center space-x-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium text-slate-800 transition-colors\"",
  "              >",
  ...
  "                    <p className=\"text-xs font-bold text-slate-400 uppercase tracking-wider\">Role-Based Portals</p>",
  "                    <p className=\"text-xs text-slate-500\">Switch user role to test specific capabilities</p>",
  "                  </div>",
  ...
  "                              {isCurrent && <span className=\"text-[10px] bg-blue-600 text-white px-1.5 rounded font-medium\">Active</span>}",
  "                            </div>",
...
write('src/components/layout/Sidebar.jsx', [
  ...
  "import { useLMS } from '../../context/LMSContext';",
  "import { LayoutDashboard, BookOpen, Video, Users, CalendarCheck, FileCheck2, DollarSign, Award, Sparkles, UserPlus, Briefcase, MessagesSquare, HelpCircle, BarChart3 } from 'lucide-react';",
  "",
  ...
  "          { id: 'leads', label: 'Lead & Admission CRM', icon: UserPlus, badge: 'Active' },",
  ...
  "          { id: 'my-learning', label: 'My Enrolled Courses', icon: Video, badge: 'Study' },",
  ...
  "          { id: 'analytics', label: 'Revenue Reports', icon: BarChart3 },",
  ...
  "          <img src={currentUser.avatar} alt={currentUser.name} className=\"w-10 h-10 rounded-full border-2 border-blue-500 object-cover\" />",
  ...
  "        <div className=\"text-[11px] font-bold uppercase tracking-wider text-slate-500 px-3 pb-2\">Navigation</div>",
  "        {navItems.map((item) => {",
  ...
  "                isActive ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-slate-800 text-slate-400 hover:text-slate-100'",
  "              }`}",
  "            >",
  "              <div className=\"flex items-center space-x-3\">",
  ...
  "              </div>",
  "              {item.badge && (",
  "                <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${isActive ? 'bg-blue-700 text-white' : 'bg-slate-800 text-blue-400'}`}>",
  "                  {item.badge}",
  "                </span>",
  "              )}",
  "            </button>",
  ...
  "          Instant doubt solving, dynamic quiz generator, and personalized study paths.",
  "        </p>",
  "        <button",
  ...
  "        LMS 2.0 • Enterprise Learning System",
  "      </div>",
  "    </aside>",
  "  );",
  "};"
...
console.log('Finished layout components.');
